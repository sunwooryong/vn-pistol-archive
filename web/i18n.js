...
(function () {
  const VI = {
    ...
    '본선 점수 추이': 'Xu hướng điểm vòng loại', '월별 10발당 평균 점수 (높을수록 좋음) · 대회 vs 훈련': 'Điểm TB/10 phát theo tháng (cao hơn = tốt hơn) · Giải vs Tập',
    'σ=일관성(작을수록 안정) · 10x=이너텐 평균 · 추이=최근 16경기 본선 흐름(끝 숫자=최근값) · 전국=현재 순위/인원': 'σ=ổn định (nhỏ=ổn) · 10x=TB inner-ten · Xu hướng=16 trận gần nhất (số cuối=mới nhất) · Toàn quốc=hạng/số người', '종목별 전국 백분위': 'Bách phân vị toàn quốc theo nội dung', 'PB 경신 타임라인': 'Dòng thời gian PB', '경신폭': 'Mức cải thiện', '현재': 'Hiện tại',
    '시리즈별 분석': 'Phân tích theo loạt', '발사 구간 경향': 'Xu hướng theo loạt bắn', '시리즈 평균': 'TB mỗi loạt', '초반': 'Đầu', '후반': 'Cuối', '경향': 'Xu hướng', '후반 강세': 'Cuối mạnh', '후반 약세': 'Cuối yếu', '안정': 'Ổn định', '월별 추이': 'Xu hướng theo tháng', '10발 평균': 'TB 10 phát', '월': 'Tháng', '유형별': 'Theo loại', '기간': 'Kỳ', '전체 기간': 'Toàn thời gian', '전국 위상': 'Vị thế toàn quốc', '전국 순위': 'Hạng toàn quốc', '지역 순위': 'Hạng khu vực', '내 평균': 'TB của tôi', '주요 경쟁자': 'Đối thủ chính', '활동': 'Hoạt động', '시즌': ' mùa', '훈련 세션': 'Buổi tập', '대회 기록': 'Lịch sử thi đấu', '단계': 'Giai đoạn', '총 경기': 'Tổng trận', '개인전 · 전 기간': 'Cá nhân · toàn thời gian',
    ...
    '팀 종합': 'Tổng quan đội', '주 종목': 'Nội dung chính', '폼': 'Phong độ',
    // 전수 번역 보강
    ...
    '약함': 'Yếu', '단계 격차': 'Chênh lệch', '보강 필요': 'Cần cải thiện', '전체 기간': 'Toàn thời gian', '전체연령': 'Mọi lứa tuổi',
