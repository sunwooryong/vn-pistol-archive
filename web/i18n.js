...
(function () {
  const VI = {
    ...
    '강·약점 레이더': 'Radar mạnh/yếu', '강·약점': 'Mạnh/Yếu', '격차': 'Chênh lệch', '종목별 전국 백분위': 'Bách phân vị toàn quốc theo nội dung', 'PB 경신 타임라인': 'Dòng thời gian PB', '경신폭': 'Mức cải thiện', '현재': 'Hiện tại',
